...
public abstract class Store {
	...
	/*
	 * 1.메서드에 abstract를 붙이면 추상메서드 됩니다. 
	 * (오버라이딩을 강제화 하고 싶을 때)
	 * 2.추상메서드는 몸체가 없는 메서드 선언입니다.
	 * 3.추상메서드를 쓰고 싶다면, 추상 클래스가 되어야합니다.
	 * 
	...
	public String name = "호식이치킨"; //변수
	public Store() {
		System.out.println("추상클래스 생성자 호출");  //생성자
	}
	public void newMenu() {
		System.out.println("본점만 가지고 있는 신메뉴"); //일반메서드
	}
